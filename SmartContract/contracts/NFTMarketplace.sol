...
contract NFTMarketplace is ERC721URIStorage {
    ...
    event Marketcre(uint256 indexed tokenId, address seller, address owner, uint256 price, bool sold);
    ...
    function createMarketItem(uint256 tokenId, uint256 price) public payable {
        ...
        emit Marketcre(tokenId, msg.sender, address(this), price, false);
    }
